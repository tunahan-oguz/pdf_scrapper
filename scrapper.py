...
KWD = ""
pdf_path = "/home/oguz/Desktop/BIL471/anatomybooks/2.pdf"
jump = 29
stop = 595
...
def extract_images_and_descriptions(pdf_path, start, stop):
    ...
    with Progress() as progress:
        page_task = progress.add_task("[green]Processing pages...", total=stop-start)
            ...
            for image_index, img in enumerate(images):
                ...
                if base_image["width"] > 50 and base_image["height"] > 50:
                    try:
                        ...
                        image_data.append((image_filename, caption_text.strip()))
